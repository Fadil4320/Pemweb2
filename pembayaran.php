        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th>No</th><th>Nokuitansi</th>
                            <th>Tanggal</th><th>Jumlah</th>
                            <th>Pesanan</th><th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                                ...
                                <td>
                                  <form action="produk_controller.php" method="post">
                                    ...
                                    <a href="index.php?hal=produk_edit&idedit=<?= $row['id']?>">
                                      ...
                                      onclick="return confirm('Apakah Anda Yakin ingin menghapus data produk yg bernama <?= $row['nokuitansi'] ?>')" tittle="Delete Produk">
